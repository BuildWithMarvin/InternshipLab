...
export function requireBearerAuth({ verifier, requiredScopes = [], resourceMetadataUrl }: BearerAuthMiddlewareOptions): RequestHandler {
    ...
    isInvalid: error instanceof InvalidTokenError,
    isOAuth: error instanceof OAuthError,
    isScope: error instanceof InsufficientScopeError,
    isServer: error instanceof ServerError,
  });
